...
2. `.codex/AGENTS.md`
3. 작업과 관련된 `.codex/*.md`
4. 관련 v1 소스: `apps/v1_api`, `apps/v1_web`
5. UI/디자인 작업이면 `docs/reference/handoff-sm-new-direction/sports-platform/project/Teameet Design.html`
...
3. 관련된 가장 좁은 v1 파일부터 읽는다. `.codex/AGENTS.md`, 관련 `.codex/*.md`, `apps/v1_api`, `apps/v1_web`, `Makefile`, 실제 설정 파일을 우선한다.
